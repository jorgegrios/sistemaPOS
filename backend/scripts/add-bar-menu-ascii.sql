...
BEGIN
    ...
    -- Get Main Menu ID
    SELECT id INTO menu_uuid FROM menus WHERE name = 'Men?? Principal' LIMIT 1;
    ...
    (cat_cocktails_classic, menu_uuid, 'Cocteles Cl??sicos', 12, true),
    ...
    -- COCKTAILS CLASSIC (8)
    INSERT INTO menu_items (id, company_id, category_id, name, price, base_price, available, active) VALUES
    (gen_random_uuid(), company_uuid, cat_cocktails_classic, 'Margarita Cl??sica', 14.00, 14.00, true, true),
    (gen_random_uuid(), company_uuid, cat_cocktails_classic, 'Mojito Cubano', 13.00, 13.00, true, true),
    (gen_random_uuid(), company_uuid, cat_cocktails_classic, 'Pi??a Colada', 14.00, 14.00, true, true),
    ...
    -- COCKTAILS HOUSE (2)
    INSERT INTO menu_items (id, company_id, category_id, name, price, base_price, available, active) VALUES
    (gen_random_uuid(), company_uuid, cat_cocktails_house, 'Sangr??a de la Casa', 11.00, 11.00, true, true),
    ...
    (gen_random_uuid(), company_uuid, cat_spirits, 'Aguardiente Antioque??o', 10.00, 10.00, true, true),
